...
style LoRA be evaluated on a fresh Colab runtime without repeating training.
...
```json
{
  ...
  "provenance": {
    "training_model": {"repository": "black-forest-labs/FLUX.1-dev", "revision": "..."},
    "evaluation_model": {"repository": "black-forest-labs/FLUX.1-dev", "revision": "..."},
    "model_format": "diffusers_pipeline",
...
Never included: FLUX base model weights, text encoder weights, VAE weights, Hugging Face
...
Real GPU behavior (FLUX model loading, image generation, and the base
