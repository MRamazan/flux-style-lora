...
| Additional LoRA validation | excluded from the first style-only public notebook; internal compatibility may remain only when required by evaluation architecture |
