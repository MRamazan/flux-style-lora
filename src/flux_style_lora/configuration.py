...
class DatasetConfig:
    ...
    def validate(self) -> None:
        if not self.trigger_word.strip():
            raise ConfigurationError("The style trigger word must not be empty.")
...
class TrainingConfig:
    project_name: str = "flux_style_lora"
    run_name: str = "style_v1"
    ...
    training_sample_every: int = 250
    raw_sample_steps: int = 20
    raw_sample_guidance: float = 4.0
