...
class StyleLoraPipeline:
    def __init__(
        self,
        workspace: str | Path = "/content/flux_style_lora",
    ...
    def setup(
        ...
        if prepare_training_assets:
            ...
            model = training_manifest["training_model"]
            details["training_assets"] = {
                "repository": model["repository"],
                "revision": model["revision"],
                "local_directory": model["local_directory"],
                "format": model["format"],
                "bundled_text_encoder": model["bundled_text_encoder"],
                "bundled_vae": model["bundled_vae"],
            }
