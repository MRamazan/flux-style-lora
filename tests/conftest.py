...
def prepared_run(tmp_path, make_lora_checkpoint):
    ...
    from flux_style_lora.manifests import write_json_atomic
        ...
        write_json_atomic(
            paths.training_asset_manifest,
            {
                "training_model": {
                    ...
                    "revision": "fluxrev",
                    "local_directory": str(paths.models / "flux1_dev"),
                    "format": "diffusers_pipeline",
                    "verified_entries": ["model_index.json", "transformer", "vae"],
