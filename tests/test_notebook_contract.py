...
NOTEBOOK = ROOT / "notebooks" / "flux_style_lora_colab.ipynb"
EVALUATION_NOTEBOOK = ROOT / "notebooks" / "flux_style_lora_evaluation_colab.ipynb"
...
def test_setup_cell_installs_package_and_initializes_pipeline() -> None:
    ...
    assert "StyleLoraPipeline" in setup
...
def test_evaluation_notebook_derives_trigger_from_imported_run() -> None:
    ...
    assert "in {TRIGGER_WORD} style" in evaluation
